#!/bin/bash
# V2 M04: Same as M03 but with symmetric edge deduplication in neighbor graph.
# Tests whether bidirectional edge double-counting (bug 4) affects training.
# Expected: 341k duplicate edges removed across gene-gene, cell-cell, drug-drug.
# Data: data/processed_v2_dedup/ (symlinked mirror of v2, fresh pickle with dedup).

set -e

MODEL_NAME="v2_M04_dedup"
...
echo "Data: $DATA_DIR (dedup pickle)"
echo "=========================================="
...
echo ""
echo "=========================================="
echo "COMPLETE — compare to v2_M03_drug_sim baseline:"
echo "  M03: Test Ind=0.957  Trans=0.959  S1=0.847  S2=0.598  S3=0.838  S4=0.587"
echo "=========================================="
